...
label = pd.read_csv('/mnt/data5/output/explore/cdiff_mean_lognorm_expression.csv').iloc[:250]['gene'].to_list()
...
train_loo(
    ...
    augment_train=True,
    balance_train=False,
    output_dir=f'/mnt/data5/output/train/cdiff-top250-loo-logcosh',
    activation='linear',
    batch_size=256,
    epochs=50,
